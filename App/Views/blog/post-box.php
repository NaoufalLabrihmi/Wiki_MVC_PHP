<!-- Post Box -->
<div class="box post-box wow fadeIn selectTitle selectCategory" selectTitle = "<?php echo $post->title; ?>"  selectCategory="<?php echo $post->category; ?>" data-wow-duration="1s">
